...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        table_programmers->setGeometry(QRect(0, 150, 571, 311));
        ...
        groupBox_6->setGeometry(QRect(-10, 10, 581, 141));
        ...
        label_scientist_error->setGeometry(QRect(250, 110, 211, 31));
        ...
        table_computers->setGeometry(QRect(0, 140, 581, 321));
        table_computers->setShowGrid(false);
        table_computers->setSortingEnabled(true);
        table_computers->horizontalHeader()->setDefaultSectionSize(134);
        groupBox_8 = new QGroupBox(tab_6);
        groupBox_8->setObjectName(QStringLiteral("groupBox_8"));
        groupBox_8->setGeometry(QRect(0, 10, 581, 159));
        ...
        button_add_computer->setGeometry(QRect(490, 90, 81, 23));
        ...
        dropdown_computer_type->setGeometry(QRect(390, 30, 181, 22));
        ...
        table_relations->setGeometry(QRect(0, 80, 581, 381));
        ...
        groupBox->setGeometry(QRect(0, 10, 581, 61));
        ...
        table_realation_person->setGeometry(QRect(10, 60, 281, 401));
        ...
        table_realation_computers->setGeometry(QRect(300, 60, 271, 401));
        ...
        groupBox_12->setGeometry(QRect(0, 10, 319, 71));
        ...
        groupBox_13->setGeometry(QRect(320, 10, 259, 71));
        ...
        table_search->setGeometry(QRect(0, 90, 581, 441));
